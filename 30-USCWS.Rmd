...
```{r CWSlogo, echo=FALSE, out.width = 500, fig.cap="(ref:CWSlogo)", fig.align = "center", fig.alt = "The US Army Chemical Corps branch insignia consists of a cobalt blue, enamel benzene ring superimposed over two crossed gold retorts that start thin in the lower corners and grow as they cross and break out of the ring."}
knitr::include_graphics("img/CBI.png")
```
...
```{r Battalionlogo, echo=FALSE, out.width = 500, fig.cap="(ref:Battalionlogo)", fig.align = "center", fig.alt = "A Gold color metal and enamel device 1 5/32 inches (2.94 cm) in height overall consisting of a shield blazoned: Or, a dragon segreant with wings inverted Gules clutching in its right front claws a lightning bolt Azure, its dexter hind paw resting upon an automobile wheel Proper. Attached below the shield a Gold color scroll inscribed `FLAMMIS VINCIMUS` in Red. "}
knitr::include_graphics("img/battalion.png")
```
